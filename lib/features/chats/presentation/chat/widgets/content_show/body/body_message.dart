          ...
          child: BalloonButton(
            ...
            onPressed: (value) {
              if (activeButton.isEmpty) {
                context.bloc<ChatCubit>().sendSelectedMenu(message.clientMessageId, value);
              }
            },
          ),
        ),
    ...
    for (var element in message.form!.fields) {
      if (element is TextFormFieldMessage) {
        ...
        items.add(
          TlTextField(
            ...
            subtitle: subtitle,
            onChanged: (value) {
              context.bloc<ChatCubit>().changeFormText(message, element.id, value);
            },
          ),
        );
      }
      ...
      if (element is CheckboxesFormFieldMessage) {
        items.add(FormCheckboxField(
          item: element,
          onChanged: (value) {
            context.bloc<ChatCubit>().changeCheckboxValue(message, value.id, value);
          },
        ));
      }
      ...
      if (element is SelectFormFieldMessage) {
        items.add(FormSelectField(
          ...
          item: element,
          onChanged: (value) {
            context.bloc<ChatCubit>().changeSelectValue(message, element.id, value);
          },
        ));
      }
      ...
      if (element is DateFormFieldMessage) {
        items.add(FormDateField(
          ...
          onChanged: (value) {
            context.bloc<ChatCubit>().changeFormDate(message, element.id, value);
          },
        ));
      }
    }
