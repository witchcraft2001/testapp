...
abstract class ChatMessagesDbDataSource {
...
@LazySingleton(
  as: ChatMessagesDbDataSource,
  env: [Environment.dev, Environment.prod],
)
class MessagesDbDataSourceImpl extends ChatMessagesDbDataSource {
  final Database _db;
  ...
  Future resetUnreadMessagesByChatId(String chatId) async {
    ...
    final messages =
        res.map((e) => ChatMessageDao.fromMap(e).copyWith(isUnread: false, readDateTime: date));
