...
abstract class LoginUserUseCase implements AsyncParamfullUseCase<void, UserUseCaseParams> {}

@Injectable(
  as: LoginUserUseCase,
  env: [Environment.dev, Environment.prod],
)
class LoginUserUseCaseImpl extends LoginUserUseCase {
  ...
  Future<void> call(UserUseCaseParams params) async {
    ...
    await _chatsRepository.loginUser();
