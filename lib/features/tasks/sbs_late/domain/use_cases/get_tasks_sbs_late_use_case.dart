...
abstract class GetTasksSbsLateUseCase
    implements AsyncParamfullUseCase<List<AppProjectSbsLate>, SearchUseCaseParams> {
  @override
  Future<List<AppProjectSbsLate>> call([SearchUseCaseParams params = const SearchUseCaseParams()]);
}
...
class GetTasksSbsLateUseCaseImpl extends GetTasksSbsLateUseCase {
  ...
  @override
  Future<List<AppProjectSbsLate>> call([
    SearchUseCaseParams params = const SearchUseCaseParams(),
  ]) async {
    final tasks = await _tasksRepository.getLateRecords(params.search);
