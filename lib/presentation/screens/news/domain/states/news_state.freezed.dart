...
/// @nodoc
mixin _$NewsState {
  List<ApiNews> get news => throw _privateConstructorUsedError;
...
class _$_NewsState implements _NewsState {
  const _$_NewsState({final List<ApiNews> news = const <ApiNews>[]})
      : _news = news;

  final List<ApiNews> _news;
  @override
  @JsonKey()
  List<ApiNews> get news {
...
abstract class _NewsState implements NewsState {
  const factory _NewsState({final List<ApiNews> news}) = _$_NewsState;
